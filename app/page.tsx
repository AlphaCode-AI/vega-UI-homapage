        ...
        <header className="mb-12">
          <div className="flex flex-col gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <Badge variant="primary" size="lg">version 0.0.1</Badge>
            </div>
          </div>
        </header>
        ...
        <section className="p-8 rounded-xl border border-ac-gray-40 flex flex-col gap-8">
          <div className="flex flex-col gap-3">
            ...
            <p className="text-md text-foreground leading-relaxed mt-2 max-w-5xl font-medium">
              VEGA UI는 Tailwind CSS 기반의 <b>알파코드 전용 토큰(<code className="text-ac-primary-50 font-bold">ac-</code>)</b>과 <b>고유 컴포넌트</b>로 구축되었습니다.<br />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 border-t border-ac-gray-40 pt-8">
            <div className="flex flex-col gap-4">
              ...
              <p className="text-md text-foreground">GitHub Repository를 통해 알파코드 패키지를 설치합니다.</p>
              <div className="rounded-lg bg-white p-4 font-mono text-sm border border-ac-gray-40 text-ac-gray-80 shadow-sm">
                npm install github:alphacode/vega-ui
              </div>
            </div>
            ...
            <div className="flex flex-col gap-4">
              ...
              <ul className="text-md text-foreground space-y-3 list-disc list-inside font-medium">
                ...
                <li>
                  <span className="text-ac-primary-50 font-bold">Token System:</span> 컬러, 간격 적용 시 반드시 <code className="bg-white px-1 border border-ac-gray-40 rounded">ac-</code> 접두사 토큰을 참조합니다.
                </li>
                <li>
                  <span className="text-ac-primary-50 font-bold">Preset Connection:</span> 테마 상속을 위해 프리셋 설정을 <code className="text-sm">tailwind.config.ts</code>에 반드시 포함합니다.
                </li>
              </ul>
            </div>
          </div>
